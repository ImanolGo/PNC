...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 182.333374, 79.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "r opeVolInfo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 153.333374, 49.296509, 75.0, 22.0 ],
					"style" : "",
					"text" : "r annVolInfo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 68.5, 49.296509, 77.0, 22.0 ],
					"style" : "",
					"text" : "r timeVolInfo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 46.0, 249.0, 46.5, 22.0 ],
					"style" : "",
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 205.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "pak 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 158.601685, 71.0, 22.0 ],
					"style" : "",
					"text" : "r masterVol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 46.0, 284.898315, 179.0, 61.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.333374, 22.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "r shaVolInfo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.0, 18.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "r engVolInfo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 46.0, 425.0, 58.0, 22.0 ],
					"restore" : 					{
...
, 			{
				"box" : 				{
					...
					"outputmode" : 1,
					"parameter_enable" : 0,
					"patching_rect" : [ 46.0, 368.0, 179.0, 46.0 ],
					"presentation" : 1,
