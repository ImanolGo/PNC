...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 809.0, 472.0, 58.0, 22.0 ],
					"restore" : 					{
						"live.dial" : [ 32.047244 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 946.5, 251.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "closebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1018.0, 251.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1018.0, 296.0, 43.0, 20.0 ],
					"style" : "",
					"text" : "recall 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 946.5, 296.0, 41.0, 20.0 ],
					"style" : "",
					"text" : "store 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 948.0, 344.0, 184.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 743.0, 304.5, 91.0, 54.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 372.0, 91.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 622.75, 228.0, 101.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 605.0, 93.0, 107.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 93.0, 107.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 605.0, 69.0, 291.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.0, 69.0, 174.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 150.0, 174.0, 22.0 ],
					"style" : "",
					"text" : "/water_recycled 51.496063"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.0, 153.0, 101.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 318.0, 24.0, 101.0, 20.0 ],
					"style" : "",
					"text" : "Current Moment"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 220.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "s moments"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 244.0, 220.0, 66.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 293.0, 46.0, 151.0, 22.0 ],
					"style" : "",
					"text" : "WAT99",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 244.0, 185.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "r moments"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 669.083374, 336.5, 62.0, 22.0 ],
					"style" : "",
					"text" : "s tcpSend"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 684.75, 258.0, 49.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 132.0, 404.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "unmute"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 631.75, 258.0, 36.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 132.0, 377.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "mute"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 419.0, 31.0, 130.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 10.0, 107.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 234.5, 14.0, 61.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 234.5, 75.5, 19.5, 19.5 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 234.5, 37.5, 85.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 694.25, 321.0, 678.583374, 321.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 641.25, 321.0, 678.583374, 321.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 244.0, 60.0, 244.0, 60.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 54.5, 216.0, 167.5, 216.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 428.5, 54.0, 583.5, 54.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 539.5, 54.0, 886.5, 54.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 253.5, 216.0, 300.5, 216.0 ],
					"source" : [ "obj-85", 0 ]
				}
		...
		"parameters" : 		{
			...
			"obj-26::obj-36" : [ "Control Number", "CC", 0 ],
